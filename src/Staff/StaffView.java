...
public class StaffView extends JInternalFrame implements ActionListener {
    private JLabel titleLabel, staffIDLabel, fullNameLabel, genderLabel, emailLabel, phoneNumLabel,
                   addressLabel, hiredDateLabel, positionLabel, basicSalaryLabel, currencyLabel,   
                   colon1, colon2, colon3, colon4, colon5, colon6, colon7, colon8;
	private JTextField staffIDField, fullNameField, genderField, emailField, phoneNumField,
                       addressField, hiredDateField, positionField;
    ...
    public void StaffViewFrame(Staff data){
        ...
        fullNameLabel.setBounds(110, 110, 130, 35);
        ...
        genderLabel.setBounds(110, 145, 130, 35);
        ...
        emailLabel.setBounds(110, 180, 130, 35);
        ...
        phoneNumLabel.setBounds(110, 215, 130, 35);
        ...
        addressLabel.setBounds(110, 250, 130, 35);
        ...
        hiredDateLabel.setFont(hiredDateLabel.getFont().deriveFont(hiredDateLabel.getFont().getSize() + 5f));
        hiredDateLabel.setBounds(110, 285, 130, 35);
        getContentPane().add(hiredDateLabel);
        ...
        fullNameField.setText(data.getFirstName() + " " + data.getLastName());
        fullNameField.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        fullNameField.setBounds(275, 110, 445, 35);
        ...
        genderField.setBounds(275, 145, 445, 35);
        ...
        emailField.setBounds(275, 180, 445, 35);
        ...
        phoneNumField.setBounds(275, 215, 445, 35);
        ...
        addressField.setBounds(275, 250, 445, 35);
        getContentPane().add(addressField);
        
        hiredDateField.setEditable(false);
        hiredDateField.setBackground(Color.white);
        hiredDateField.setText(data.getHiredDate());
        hiredDateField.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        hiredDateField.setBounds(275, 285, 445, 35);
        getContentPane().add(hiredDateField);
